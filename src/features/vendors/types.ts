...
export function mapApiVendor(raw: ApiVendor, fallbackIdx = 0): Vendor {
  ...
  const vendorName =
    raw.company_name || raw.name || fullName || "Vendor Partner";
  ...
  return {
    ...
    profile_pic: raw.profile_image_url || raw.logo || undefined,
    gstNumber: raw.gst_number || undefined,
    panNumber: raw.pan_number || undefined,
    licenseNumber: raw.license_number || undefined,
    vehicleCategories: Array.isArray(raw.vehicle_categories)
      ? raw.vehicle_categories
      : [],
    operatingCities: Array.isArray(raw.operating_cities)
