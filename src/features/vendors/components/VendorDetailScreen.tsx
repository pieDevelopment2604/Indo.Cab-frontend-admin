...
export default function VendorDetailScreen({
  ...
  const tripColumns: Column<TripRecord>[] = [
    {
      header: "Trip ID",
      accessorKey: "id",
      className: "font-mono text-xs font-bold text-neutral-700",
    },
    {
      header: "Driver",
      cell: (trip) => (
  ...
  const vendorName =
    selectedVendor.name || selectedVendor.companyName || "Vendor Partner";
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-5">
        ...
        <div className="flex flex-col gap-1">
          <button
            ...
            className="inline-flex gap-1.5 text-xs font-semibold text-neutral-400 hover:text-neutral-700 transition-colors cursor-pointer w-fit items-normal"
          >
            <ArrowLeft size={13} />
            Vendor Partners
          </button>
          ...
          <div className="flex items-center gap-2 mt-0.5">
            <StatusBadge
              ...
              pulse={selectedVendor.status === "active"}
            />
        ...
        <div className="lg:col-span-8 flex flex-col gap-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {[
              ...
              <div
                key={label}
                className={`card p-5 flex flex-col gap-2 ${accent}`}
              >
                ...
                <span className={`text-[11px] font-semibold ${subColor}`}>
                  {sub}
                </span>
              </div>
            ))}
